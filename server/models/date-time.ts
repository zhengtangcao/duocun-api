...
export class DateTime {
  ...
  getMomentFromLocal(localTime: string, zone='America/Toronto'){
  ...
  getLatestMoment(myLocalTime: string, ms: moment.Moment[]) {
    const now = this.getMomentFromLocal(myLocalTime);
